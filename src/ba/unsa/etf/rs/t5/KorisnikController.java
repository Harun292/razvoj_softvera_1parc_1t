...
public class KorisnikController {
    ...
    public void initialize() {
        //if(fldPasswordRepeat.getText().isEmpty())
        ...
        model.trenutniKorisnikProperty().addListener((obs, oldKorisnik, newKorisnik) -> {
            if (oldKorisnik != null) {
                ...
                //fldPonovi.textProperty().unbindBidirectional(oldKorisnik.passwordProperty());
            }
            if (newKorisnik == null) {
                fldIme.setText("");
                fldPrezime.setText("");
                ...
                //fldPonovi.textProperty().bindBidirectional(newKorisnik.passwordProperty());
            }
        });
        ...
        fldPassword.textProperty().addListener((obs, oldIme, newIme) -> {
            if (!newIme.isEmpty()&&!fldPasswordRepeat.getText().isEmpty()) {
                fldPassword.getStyleClass().removeAll("poljeNijeIspravno");
                fldPassword.getStyleClass().add("poljeIspravno");
                if(fldPasswordRepeat.getText().trim().equals(fldPassword.getText().trim())){
        ...
        if(fldPassword.getText().trim().equals(fldPasswordRepeat.getText().trim())) {
            fldPasswordRepeat.getStyleClass().removeAll("poljeNijeIspravno");
            fldPasswordRepeat.getStyleClass().addAll("poljeIspravno");
            fldPassword.getStyleClass().removeAll("poljeNijeIspravno");
            fldPassword.getStyleClass().add("poljeIspravno");
    ...
    {
        model.izbrisi(model.getTrenutniKorisnik());
    }
}
